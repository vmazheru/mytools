...
public interface ExceptionDecorators {
    ...
    static Runnable unchecked(
            Class<? extends RuntimeException> exceptionClass, RunnableWithException f) {
    ...
    static <R> Supplier<R> unchecked(
            Class<? extends RuntimeException> exceptionClass, SupplierWithException<R> f) {
    ...
    static <T> Consumer<T> unchecked(
            Class<? extends RuntimeException> exceptionClass, ConsumerWithException<T> f) {
    ...
    static <T,U> BiConsumer<T,U> unchecked(
            Class<? extends RuntimeException> exceptionClass, BiConsumerWithException<T,U> f) {
    ...
    static <T,R> Function<T,R> unchecked(
            Class<? extends RuntimeException> exceptionClass, FunctionWithException<T,R> f) {
    ...
    static <T,U,R> BiFunction<T,U,R> unchecked(
            Class<? extends RuntimeException> exceptionClass, BiFunctionWithException<T,U,R> f) {
    ...
    static <R> Supplier<R> safe(
            SupplierWithException<R> f, Class<? extends Exception> ... exceptions) {
    ...
    static <T,R> Function<T,R> safe(
            FunctionWithException<T,R> f, Class<? extends Exception> ... exceptions) {
    ...
    static <T,U,R> BiFunction<T,U,R> safe(
            BiFunctionWithException<T,U,R> f, Class<? extends Exception> ... exceptions) {
